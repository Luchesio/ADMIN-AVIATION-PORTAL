...
// Fetch canceled tickets
$result = $con->query("SELECT * FROM ticket WHERE status = 'canceled'");
...
<a href="index.php" class="navlink"><i class="fas fa-user" style=" margin-right:17px;" ></i><span id="dashboard">Dashboard</span></a>
    ...
    <div class="menu">
        ...
        <a href="" class="navlink">Cancelled Flights</a>
    </div>
    <div class="bodyy">
        <nav class="second">
            <div class="dash">Canceled Flights</div>
            <div>something</div>
        </nav>
